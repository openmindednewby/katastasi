...
- **TASK-12** Phase 4: more CI providers · KAT-8
- **TASK-13** Phase 4: docs site · KAT-8
- **TASK-14** Phase 4: flaky-test detection · KAT-8
- **TASK-15** Verify: real-AI acp analyze end-to-end run (needs OPENAI/GITHUB token) · KAT-6, KAT-9
- **TASK-16** Verify: pull/push end-to-end against a real Jira/Confluence sandbox · KAT-1, KAT-9
- **TASK-17** Verify: live connected-Chrome visual QA pass of the trace portal · KAT-2, KAT-9
- **TASK-18** Add unit tests for n8n payload builders (toWebhookBody) + validators · KAT-1
- **TASK-19** Wire ACP_BACKEND=direct into the forward acp jira/confluence publish · KAT-1
